...
public class BlockBloomery extends BlockBase implements ITileEntityProvider{
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool BURNING = PropertyBool.create("burning");

	public BlockBloomery(String name) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(BlockInit.BLOOMERY);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(BlockInit.BLOOMERY);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!worldIn.isRemote) {
			playerIn.openGui(Main.instance, Reference.GUI_BLOOMERY, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) worldIn.setBlockState(pos, BlockInit.BLOOMERY.getDefaultState()
				.withProperty(FACING, state.getValue(FACING))
				.withProperty(BURNING, true), 3);
		else worldIn.setBlockState(pos, BlockInit.BLOOMERY.getDefaultState()
				.withProperty(FACING, state.getValue(FACING))
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityBloomery tileEntity = (TileEntityBloomery)worldIn.getTileEntity(pos);
