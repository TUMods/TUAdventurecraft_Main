...
public class ItemChestnut extends FoodBase implements IHasModel, IPlantable {

	public ItemChestnut(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		return BlockInit.CROP_SAPLING_CHESTNUT.getDefaultState();
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (facing == EnumFacing.UP && player.canPlayerEdit(pos.offset(facing), facing, stack) 
			...
			worldIn.setBlockState(pos.up(), BlockInit.CROP_SAPLING_CHESTNUT.getDefaultState());
			stack.shrink(1);
