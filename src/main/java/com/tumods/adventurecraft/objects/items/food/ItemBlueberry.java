...
public class ItemBlueberry extends FoodBase implements IHasModel, IPlantable {

	public ItemBlueberry(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		return BlockInit.CROP_BLUEBERRY.getDefaultState();
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (facing == EnumFacing.UP && player.canPlayerEdit(pos.offset(facing), facing, stack) 
			...
			worldIn.setBlockState(pos.up(), BlockInit.CROP_BLUEBERRY.getDefaultState());
			stack.shrink(1);
