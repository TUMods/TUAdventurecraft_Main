...
public class WorldGenTreeChestnut extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.LOG_CHESTNUT.getDefaultState();
	private static final IBlockState LEAF = BlockInit.LEAVES_CHESTNUT.getDefaultState();
	
	private final int minHeight;
	private final int heightVariation;
	
	public WorldGenTreeChestnut() {
		super(false);
		this.minHeight = 4;
